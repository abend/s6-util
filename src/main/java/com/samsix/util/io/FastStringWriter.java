...
/**
 * Identical to StringWriter, but uses a StringBuilder internally (which has no locking).
 * Also allows you to use an existing StringBuilder for internal bits.
 */
        ...
        Writer
{
    ...
    /**
     * Create a new string writer using an existing String builder.
     *
     * Careful not to use the string simultaneously or you may end up
